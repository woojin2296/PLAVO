      ...
      <ProjectHeader uuid={params.uuid} />
      {
        data.id ? (
          <div className="flex flex-col pt-20 gap-4">
            ...
            <span className="text-4xl px-4 text-color_main2">최종 연습 점수</span>
              ...
              <CardContent className="flex items-center">
                <div className="w-full pr-4">
                  <div className="flex items-center gap-2">
                    ...
                    <CardTitle className="text-4xl text-color_main1">{data.total_score}점</CardTitle>
                    <CardDescription className="text-4xl py-4">입니다.</CardDescription>
                  </div>
                  <div className="flex justify-between">
                    <div className="flex items-center gap-8 pr-8">
                      <CardDescription className="text-2xl py-4">발화 속도</CardDescription>
                      <CardTitle
                        className={`text-4xl ${data.speed_score <= 30
                          ? "text-red-500"
                          : data.speed_score <= 60
                            ? "text-orange-500"
                            : "text-green-500"
                      ...
                      >
                        {Math.round(data.speed_score)}
                      </CardTitle>
                    </div>
                    <div className="flex items-center gap-8 pr-8">
                      <CardDescription className="text-2xl py-4">발음 정확도</CardDescription>
                      <CardTitle
                        className={`text-4xl ${data.pronunciation_score <= 30
                          ? "text-red-500"
                          : data.pronunciation_score <= 60
                            ? "text-orange-500"
                            : "text-green-500"
                          }`}
                      >
                        {Math.round(data.pronunciation_score)}
                      </CardTitle>
                    </div>
                    <div className="flex items-center gap-8 pr-8">
                      <CardDescription className="text-2xl py-4">제스처 점수</CardDescription>
                      <CardTitle
                        className={`text-4xl ${data.pose_score <= 30
                          ? "text-red-500"
                          : data.pose_score <= 60
                            ? "text-orange-500"
                            : "text-green-500"
            ...
            <span className="text-4xl pt-6 px-4 text-color_main2">발화 속도 분석</span>

            <Card className="flex flex-col gap-0 text-text_default">
              <CardContent className="flex items-center">
                <CardTitle className="text-2xl pt-6">
                  평균 속도 :
                  <span className="text-color_main1"> {data.speaking_speed_analysis_average_speed}</span>
                </CardTitle>
              </CardContent>
            </Card>
            ...
            <Card className="flex flex-col gap-0 text-text_default">
              <CardContent className="pt-6">
                <CardTitle className="text-2xl pb-2">시간대별 속도</CardTitle>
                <CardDescription className="text-2xl">
                  {data.speaking_speed_analysis_speed_by_time_slot
                    .split(",")
            ...
            <Card className="flex flex-col gap-0 text-text_default">
              <CardContent className="pt-4">
                <CardTitle className="text-2xl py-2">속도 변화</CardTitle>
                <CardDescription className="text-2xl">{data.speaking_speed_analysis_speed_variation}</CardDescription>
              </CardContent>
            </Card>

            <span className="text-4xl pt-6 px-4 text-color_main2">제스처 분석</span>
            ...
            <span className="text-4xl pt-6 px-4 text-color_main2">개선점 및 피드백</span>
            ...
            <span className="text-4xl pt-6 px-4 text-color_main2">추가 연습 추천</span>
            ...
            <span className="text-4xl pt-6 px-4 text-color_main2">다음 단계</span>
